    ...
    <>
      <View style={styles.container}>
        <ScrollView>
          ...
          <IllustratedText
            texte="Évaluer et réduire l'émission de CO2 produite par les salariés"
            image={require('../assets/img/reductionCO2.png')}
          />
          <IllustratedText
            texte="Un challenge entre entreprise ! Qui sera la meilleure entreprise ?"
            image={require('../assets/img/challenge.png')}
          />
          <IllustratedText
            texte="Une solution de covoiturage pour vous !"
            image={require('../assets/img/covoiturage.png')}
          />
          ...
          <View style={styles.block}>
            ...
            <View style={styles.boxCovoit}>
              ...
              <Text style={styles.texte}>
                TOUTES FRAUDES OU TRICHES AU CHALLENGE SERONT SÉVÈREMENT
                SANCTIONNÉS.
              </Text>
            </View>
          </View>
